...
public class AdminController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         String action = url[1];
          ...
          break;
          case "listeCategories"  :listeCategories(request,response); 
          break;            
    ...
    private void AddProduct(HttpServletRequest request, HttpServletResponse response) throws IOException {
      ...
      if(produitServices.AddProduit(new Produit(nom, description, designation, prix, name, unite, m, c)))
      {
         ...
         // response.getWriter().append("Produit bien ajouté");
           response.sendRedirect("../productliste.jsp");
      }
      else 
          response.getWriter().append("errrrrror ");
              ...
              response.getWriter().append("errrrorccc");
    ...
    private void getProduit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/productliste.jsp");
      //dispatcher.forward(request, response);    
      response.getWriter().append("yarebi rak 3arf" +produits);
    }
